...
def divide(quotients, divisors):
    ...
    """
    return {qoutient: [divisor for divisor in divisors if divisor % qoutient] for qoutient in quotients}
...
def distance(city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    lat_diff = abs(get_lat(city_a) - get_lat(city_b))
    lon_diff = abs(get_lon(city_a) - get_lon(city_b))
