...
A dise function takes no arguments and returns a number from 1 to n
...
def make_fair_dice(sides):
    """Return a dise that returns 1 to SIDES with equal chance."""
...
def make_test_dice(*outcomes):
    """Return a dise that cycles deterministically through OUTCOMES.
